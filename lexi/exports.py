...
def export_pdf(text: str, title: str = "LexiAssist Analysis") -> bytes:
    ...
    _cell(
        pdf, 0, 5,
        f"Generated by {firm} via {BRAND_LABEL} — Verify all citations independently",
        align="C", has_unicode=has_uni,
    )
    _cell(
        pdf, 0, 5,
...
def _docx_add_footer(doc, firm: str) -> None:
    ...
    ft   = firm if firm and firm != "LexiAssist" else BRAND_LABEL
    disc = f"{ft}  \u00b7  {BRAND_LABEL}  \u00b7  Verify all citations independently"
...
def export_docx(text: str, title: str = "LexiAssist Analysis",
    ...
    rm=mp.add_run(f"{firm}   \u00b7   {date_str}   \u00b7   Generated by {BRAND_LABEL}")
    ...
    rd=disc.add_run(f"\u26a0  AI-generated via {BRAND_LABEL}. Not legal advice. "
...
def export_txt(text: str, title: str = "LexiAssist Analysis") -> str:
    ...
    footer = (
        ...
        f"DISCLAIMER\n"
        f"{'-' * 70}\n"
        f"This document is an AI-generated drafting aid produced by {BRAND_LABEL}.\n"
        f"It does NOT constitute legal advice.\n\n"
...
def export_html(text: str, title: str = "LexiAssist Analysis") -> str:
    ...
    meta_parts.append(f"{BRAND_LABEL}")
    ...
    return (f"<!DOCTYPE html><html><head><meta charset='utf-8'>"
            ...
            f"<div class='footer'>"
            f"<strong>\u26a0 IMPORTANT:</strong> AI-generated via {BRAND_LABEL}. "

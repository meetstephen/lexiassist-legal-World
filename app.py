...
# ═══════════════════════════════════════════════════════
# ═══════════════════════════════════════════════════════
# THEMES (CSS) - LexTheme Professional Edition
# ═══════════════════════════════════════════════════════
THEMES = {
    "🏛️ LexTheme Dark": {
        "display_name": "🏛️ LexTheme Dark",
        "description": "Premium dark mode with gold accents — LexTheme Original.",
        "bg":               "#121212",
        "bg_secondary":     "#1A1A1A",
        "card_bg":          "#1A1A1A",
        "border":           "#2A2A2A",
        ...
        "accent_secondary": "#B5952F",
        "positive":         "#10B981",
        "negative":         "#EF4444",
        "warning":          "#F59E0B",
        "sidebar_bg":       "#0A0A0A",
        "input_bg":         "#202020",
        "header_gradient":  "linear-gradient(135deg, #0A0A0A, #1A1A1A)",
    },
    "🏛️ LexTheme Light": {
        "display_name": "🏛️ LexTheme Light",
        "description": "High-contrast professional light mode with gold accents.",
        "bg":               "#F8FAFC",
        "bg_secondary":     "#F1F5F9",
        "card_bg":          "#FFFFFF",
        "border":           "#E2E8F0",
    ...
    "⚖️ Corporate": {
        ...
        "description": "Classic navy & gold — traditional law firm portal.",
        "bg":               "#f4f6f9",
        "bg_secondary":     "#e8edf4",
        "card_bg":          "#ffffff",
        "border":           "#c5d0e0",
...
def get_theme(name: str) -> dict:
    ...
    return THEMES.get(name, THEMES["🏛️ LexTheme Dark"])
